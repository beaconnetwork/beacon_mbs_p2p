...
docker run -d -it --name beacon_mbs_p2p_n5 -p 5883:1883 beacon/mbs_p2p:03.30.alpine.3.8
docker run -d -it --name beacon_mbs_p2p_n6 -p 6883:1883 beacon/mbs_p2p:03.30.alpine.3.8
docker run -d -it --name beacon_mbs_p2p_n7 -p 7883:1883 beacon/mbs_p2p:03.30.alpine.3.8
